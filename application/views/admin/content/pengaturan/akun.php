<h1>Informasi Daftar Pengguna</h1>
<div class="clear"></div>
    ...
    <form id="formMenu" action="<?php echo site_url();?>pengaturan/pengguna/edit" method="post" onSubmit="return validate()">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><input name="admin_user" type="text" id="admin_user" value="<?php echo $admin_user; ?>" readonly="readonly" size="30"
              maxlength="25" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input name="admin_nama" type="text" id="admin_nama" value="<?php echo $admin_nama; ?>" size="30" maxlength="30"
            /></td>
        </tr>
        <tr>
          <td width="130"><label for="admin_alamat" class="required">Alamat <span class="required">*</span></label></td>
          <td><input name="admin_alamat" type="text" id="admin_alamat" value="<?php echo $admin_alamat; ?>" size="50" maxlength="255"
            /></td>
        </tr>
        <tr>
          <td width="130"><label for="admin_telepon" class="required">Telepon <span class="required">*</span></label></td>
          <td><input name="admin_telepon" type="text" id="admin_telepon" value="<?php echo $admin_telepon; ?>" size="15" maxlength="15"
            /></td>
        </tr>
        <tr>
      ...
      <div style="padding:20px 0 0 0px; text-align:center">
        <input class="formbut" type="submit" name="simpan" value="Simpan Data" />&nbsp;
        <input class="formbut" type="reset" name="batal" value="Batalkan" onclick="location.href='<?php echo site_url();?>pengaturan/pengguna'"
        />
      </div>
    </form>
  </div>
