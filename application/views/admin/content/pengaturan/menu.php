        ...
        <div class="col-sm-12 col-md-12">
            <div class="block-flat">
                <div class="content">
                    ...
                    <!-- ========== End Flashdata ========== -->
                    <!-- ========== Button ========== -->
                    <form action="<?php echo base_url();?>pengaturan/menu" method="post" id="form">
	                        ...
	                        if ($jml_data > 0){
	                            ...
	                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo site_url().$row->menu_url;?>
                                        </td>
                                        <td align="center">
                                            <!-- ========== EDIT DETAIL HAPUS ========== -->
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right" role="menu">
                                                    ...
                                                    <li>
                                                        <a data-toggle="modal" data-target="#mod-info" type="button" href="<?php echo site_url();?>pengaturan/menu_detail/<?php echo $row->menu_kode;?>"
                                                            rel="detail" title="Detail <?php echo $row->menu_nama; ?>"><i class='fa fa-eye'></i> Detail</a>
                                                    </li>
                                                    <li>
...
<div class="page-head">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>admin"><i class='fa fa-home'></i> Dashboard</a></li>
        <li>
            <a href="<?php echo base_url();?>pengaturan/menu">
                <?php echo $breadcrumb; ?>
            </a>
        </li>
...
<div class="cl-mcont">
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form role="form" class="form-horizontal" action="<?php echo site_url();?>pengaturan/menu/tambah" method="post" enctype="multipart/form-data"
                            ...
                            <table class="table no-border hover">
                                ...
                                <tbody class="no-border-y">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="menu_nama" type="text" id="menu_nama" required class="form-control input-sm" value="<?php echo $menu_nama;?>"
                                                size="30" maxlength="255" placeholder="Masukan Nama Menu" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input name="menu_deskripsi" type="text" required class="form-control input-sm" id="menu_deskripsi" value="<?php echo $menu_deskripsi;?>"
                                                size="50" maxlength="255" placeholder="Masukan Deskripsi Menu" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input name="menu_url" type="text" required class="form-control input-sm" id="menu_url" value="<?php echo $menu_url;?>" size="50"
                                                maxlength="255" placeholder="Masukan URL Menu" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="menu_urutan" type="text" required class="form-control input-sm" id="menu_urutan" value="<?php echo $menu_urutan;?>"
                                                size="20" maxlength="25" placeholder="Masukan Urutan Menu" />
                                        </td>
                                    </tr>
                                    <?php if ($menu_level == 2) {?>
                                    <tr>
...
<div class="cl-mcont">
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form role="form" class="form-horizontal" action="<?php echo site_url();?>pengaturan/menu/edit" method="post" enctype="multipart/form-data"
                        parsley-validate novalidate>
                        <input type="hidden" name="menu_kode" value="<?php echo $menu_kode;?>" />
                        <div class="table-responsive">
                            <table class="table no-border hover">
                                <tbody class="no-border-y">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="menu_nama" type="text" id="menu_nama" value="<?php echo $menu_nama;?>" size="30" maxlength="255" required class="form-control input-sm"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="menu_deskripsi" type="text" id="menu_deskripsi" value="<?php echo $menu_deskripsi;?>" size="50" maxlength="255"
                                                required class="form-control input-sm" placeholder="Masukan Deskripsi Menu" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td><input name="menu_url" type="text" id="menu_url" value="<?php echo $menu_url;?>"
                                                size="50" maxlength="255" required class="form-control input-sm" placeholder="Masukan URL Menu"
                                            /></td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="menu_urutan" type="text" id="menu_urutan" value="<?php echo $menu_urutan;?>" size="20" maxlength="25" required
                                                class="form-control input-sm" placeholder="Masukan Urutan Menu" />
                                        </td>
                                    </tr>
                                    <?php if ($menu_level == 2) {?>
                                    <tr>
    ...
    <div class="table-responsive">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" id="form_detail">
            <tr class="awal">
                ...
                <td>:
                    <?php echo $menu->menu_level;?>
                </td>
            </tr>
            <tr>
                <td width="110">Nama Menu</td>
                <td>:
                    <?php echo $menu->menu_nama;?>
                </td>
            </tr>
            <tr class="awal">
                <td>Deskripsi</td>
                <td>:
                    <?php echo $menu->menu_deskripsi;?>
                </td>
            </tr>
            <tr>
                <td>URL</td>
                <td>:
                    <?php echo site_url().$menu->menu_url;?>
                </td>
            </tr>
            <tr class="awal">
                <td>Urutan</td>
                <td>:
                    <?php echo $menu->menu_urutan;?>
                </td>
            </tr>
        </table>
    </div>
...
<div class="modal-footer">
    <a type="button" class="btn btn-default" href="<?php echo site_url();?>pengaturan/menu">Kembali</a>
</div>
<!-- ================================================== END DETAIL ================================================== -->
        ...
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    ...
                    <?php } ?>
                    <!-- ========== End Flashdata ========== -->
                    <form role="form" class="form-horizontal" action="" name="formHakAkses" method="post" enctype="multipart/form-data" parsley-validate
                        novalidate>
                        <div class="table-responsive">
                            <table class="table no-border hover">
                                <tbody class="no-border-y">
