        ...
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    ...
                    <?php } ?>
                    <!-- ========== End Flashdata ========== -->
                    <form role="form" id="formMenu" class="form-horizontal" action="<?php echo site_url();?>admin/edit_password" method="post"
                        ...
                        <div class="table-responsive">
                            <table class="table no-border hover">
                                ...
                                <tbody class="no-border-y">
                                    <tr>
                                        ...
                                        <td><input name="admin_pass_recent" required class="form-control" type="password" id="admin_pass_recent"
                                                value="" size="30" maxlength="50" /></td>
                                    </tr>
                                    <tr>
                                        <td><label for="admin_pass">Password Baru <span class="required">*</span></label></td>
                                        <td><input name="admin_pass" required class="form-control" type="password" id="admin_pass"
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="admin_pass_ulang" required class="form-control" type="password" id="admin_pass_ulang"
                                                value="" size="30" maxlength="50" onkeyup="checkPass(); return false;" />
                            ...
                            <input class="btn btn-default" type="reset" name="batal" value="Batalkan" onclick="location.href='<?php echo site_url();?>pengaturan/pengguna'"/></div>
                        </form>
                    </div>
                </div>
            </div>
